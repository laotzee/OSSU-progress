...
;; Produce true if s is in a list of strings, false otherwise
...
(check-expect (contains? "Higuerote" (cons "McGill" (cons "UBC" empty))) false)
...
;; ListOfNumbers Function -> ListOfNumbers
;; Affects all elements in a ListOfNumbers given a function

(check-expect (map2 sqr empty) empty)
(check-expect (map2 sqrt empty) empty)
(check-expect (map2 sqrt (list 9)) (list 3))
(check-expect (map2 sqr (list 3)) (list 9))
(check-expect (map2 sqrt (list 9 16)) (list 3 4))
(check-expect (map2 sqr (list 3 4)) (list 9 16))
(check-expect (map2 abs (list -3 -5 3 5 -8 -2)) (list 3 5 3 5 8 2))
...
;; Function ListOfNumber -> ListOfNumbers
;; Filters numbers in a ListOfNumbers depending on pred
...
(check-expect (filter2 even? (list 1 -2 3 -4 8 6 4))
              (list -2 -4 8 6 4))
